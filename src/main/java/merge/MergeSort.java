...
public class MergeSort {
    ...
    private static void sortFile(final String path) throws Exception {
     ...
     * @throws Exception
     */
    private static void splitFile(final String inputPath, final int numSize) throws Exception {
     ...
     * @throws Exception
     */
    private static void mergeFile(final List<String> splitFilePathList, final String outputPath)
                                                                                    throws Exception {
        //fileInfo添加到set
     ...
     * @throws Exception
     */
    private static int createRandomNum(final long numSize) throws Exception {
    ...
    private static void createDir(final String dirPath) {
    ...
    private static void writeFile(final String path, final Set<Integer> set, final boolean isAppend) throws Exception {
        File file = new File(path);
